 ...
 */
final class Version20250425002918 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE abonnement_data (id INT AUTO_INCREMENT NOT NULL, abonnement_id INT NOT NULL, sportif_id INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, INDEX IDX_D4C0D039F1D74413 (abonnement_id), INDEX IDX_D4C0D039FFB7083B (sportif_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE abonnement_data ADD CONSTRAINT FK_D4C0D039F1D74413 FOREIGN KEY (abonnement_id) REFERENCES abonnement (id)');
        $this->addSql('ALTER TABLE abonnement_data ADD CONSTRAINT FK_D4C0D039FFB7083B FOREIGN KEY (sportif_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE abonnementdata (DateDebut DATE NOT NULL, DateFin DATE NOT NULL, id_Abonnement INT NOT NULL, id_Sportif INT NOT NULL, INDEX abonnementdata_ibfk_2 (id_Sportif), INDEX abonnementdata_ibfk_1 (id_Abonnement)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE abonnement_data DROP FOREIGN KEY FK_D4C0D039F1D74413');
        $this->addSql('ALTER TABLE abonnement_data DROP FOREIGN KEY FK_D4C0D039FFB7083B');
        $this->addSql('DROP TABLE abonnement_data');
