 ...
 */
final class Version20250426110400 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP reset_code, CHANGE is_blocked is_blocked TINYINT(1) NOT NULL, CHANGE reset_token reset_token VARCHAR(255) DEFAULT NULL, CHANGE reset_token_expires_at reset_token_expiration DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD reset_code VARCHAR(6) DEFAULT NULL, CHANGE is_blocked is_blocked TINYINT(1) DEFAULT 0 NOT NULL, CHANGE reset_token reset_token VARCHAR(64) DEFAULT NULL, CHANGE reset_token_expiration reset_token_expires_at DATETIME DEFAULT NULL');
    }
}
