 ...
 */
final class Version20250425075105 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paiement CHANGE paymentIntentId payment_intent_id VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE paiement CHANGE payment_intent_id paymentIntentId VARCHAR(255) NOT NULL');
